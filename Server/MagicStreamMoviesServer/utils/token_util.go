...
func validateToken(tokenString string, KEY string) (*SignedDetails, error) {
	claims := &SignedDetails{}
...
func ValidateRefreshToken(tokenString string) (*SignedDetails, error) {
	return validateToken(tokenString, SECRET_REFRESH_KEY)
}

func ValidateNormalToken(tokenString string) (*SignedDetails, error) {
	return validateToken(tokenString, SECRET_KEY)
}
